...
export const THEME_DEFS = {
  ...
  sushi: {
    ...
    paddle: { wMul: 1.35 },
    ball: { color: 0xff6a4a, emissive: 0xff3a1a, metalness: 0.0, roughness: 0.6, emissiveIntensity: 0.15, light: 0.6, style: "shrimp" },
    apply: (b) => ({
      ...b,
      ...matteMaterials,
      style: "sushi",
  ...
  spiaggia: {
    id: "spiaggia",
    name: "Spiaggia",
    swatch: [0xffe08a, 0x4dc9f0, 0xd4956b],
    spectators: "stadium",
    paddle: { wMul: 1 },
    ball: { color: 0xff6a3d, emissive: 0xff3a1a, metalness: 0.02, roughness: 0.7, emissiveIntensity: 0.08, light: 0.35 },
    apply: (b) => ({
      ...b,
      ...matteMaterials,
      style: "spiaggia",
    ...
    ui: {
      "--bg": "#0b1d28", "--panel": "rgba(14, 35, 45, 0.88)",
      "--panel-2": "rgba(18, 48, 62, 0.96)", "--line": "rgba(255, 224, 138, 0.22)",
      "--mint": "#ffe08a", "--mint-dim": "rgba(255, 224, 138, 0.17)",
      "--pink": "#ff88bb", "--pink-dim": "rgba(255, 136, 187, 0.17)",
      "--gold": "#f0d090", "--ice": "#b8e8f8",
      "--text": "#f5f0e0", "--muted": "#aabbc0"
    }
  }
};
